...
const SEED_RECORD = [
  { name: '午餐', simpleDate: '2022-06-25', amount: 60, user: '廣志', category: '餐飲食品' },
  { name: '晚餐', simpleDate: '2022-06-25', amount: 60, user: '廣志', category: '餐飲食品' },
  { name: '捷運', simpleDate: '2022-06-26', amount: 120, user: '廣志', category: '交通出行' },
  { name: '電影：驚奇隊長', simpleDate: '2022-06-26', amount: 220, user: '小新', category: '休閒娛樂' },
  { name: '租金', simpleDate: '2022-06-04', amount: 25000, user: '廣志', category: '家居物業' }
]
db.once('open', async () => {
